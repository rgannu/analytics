...
- Start the AMQP receiver/consumer to monitor the AVRO messages.
```bash
...
# You should be able to see the decoded AMQP messages in the consumer window, something like below:
Decoded AVRO message:{"before": null, "after": {"id": 4, "uuid": "21cc1b49-2e3a-443a-879d-1eeb95cc3d08", "version": 0}, "source": {"version": "1.2.0.Beta2", "connector": "postgresql", "name": "dbanalytics", "ts_ms": 1595431821598, "snapshot": "false", "db": "services", "schema": "services", "table": "test_table", "txId": 606, "lsn": 45567480, "xmin": null}, "op": "c", "ts_ms": 1595431821817, "transaction": null}
Decoded Specific AVRO message:{"before": null, "after": {"id": 4, "uuid": "21cc1b49-2e3a-443a-879d-1eeb95cc3d08", "version": 0}, "source": {"version": "1.2.0.Beta2", "connector": "postgresql", "name": "dbanalytics", "ts_ms": 1595431821598, "snapshot": "false", "db": "services", "schema": "services", "table": "test_table", "txId": 606, "lsn": 45567480, "xmin": null}, "op": "c", "ts_ms": 1595431821817, "transaction": null}
```
